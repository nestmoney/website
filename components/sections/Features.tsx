      ...
      >
        ...
        <div className="space-y-[32px] lg:space-y-0">
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.4 }}
            className="flex flex-col md:flex-row items-center justify-between gap-0 md:gap-11 lg:gap-0"
          >
            <Image
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: true, amount: 0.4 }}
            className="flex flex-col md:flex-row-reverse items-center justify-between gap-0 md:gap-11 lg:gap-0"
          >
            <Image
              className="w-[160px] md:w-[240px] lg:w-[320px] h-auto object-contain shrink-0"
              src="/cards.png"
